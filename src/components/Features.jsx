...
const featureList = [
  {
    ...
    header: '創新',
    content:
      'regimen在尊重傳統的同時追求創新，中藥藥渣梘結合了減碳，回收及中醫學術研究，在市場上別樹一幟。 我們同時亦致力於進行不同試驗，為求提供最好的產品。',
  },
  {
    icon: <Icon type="rise" {...iconProps} theme="outlined" />,
    header: '高成效',
    content:
      'regimen的中藥藥渣梘是基於中醫的「內服外用，雙管齊下」的意念而誕生，務求將一服中藥的藥效全部萃取給用戶。 中藥梘用於日常，對長期病患者的幫助尤其顯著',
  },
  {
    icon: <Icon type="user" {...iconProps} theme="outlined" />,
    header: '度身訂造',
    content:
      'regimen總是希望為用戶提供最好的服務，因此我們不倦於設計度身訂造的產品，我們首個計劃「中藥藥渣梘」正正是為此而設。',
  },
  {
    icon: <Icon type="smile" {...iconProps} />,
    header: '關心你的需求',
    content:
      '我們深明與顧客的關係是一間公司最重要的財富，因此regimen總是會透過不同形式去關心你的需求，如果你有意見想分享，歡迎電郵或在Instagram上inbox我們。',
  },
];
